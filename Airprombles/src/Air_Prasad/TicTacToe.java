  ...
  static int moveI,moveJ;    //board indexes of current AI moves - used in printBoard() 
 	...
 	//Initializing board  
 	 	...
 	 	public static void selectSymbol(){ 	 	 	 	 	 	//Select Symbol (X | O) 
 	 	 	...
 	 	 	humanPlayer = (input.equalsIgnoreCase("x")) ? "X" : "O";  	aiPlayer = (humanPlayer.equals("X")) ? "O" : "X"; 
...
for(int j=0;j<3;j++){ 
  ...
  public static boolean validMove(int boardNumber)  //Check if position on board is empty 
 	 	{ 
 	 	 	...
 	 	 	if(!board[indexes[0]][indexes[1]].equals(" "))  	 	 	 	return false; 
 	 	 	return true; 
 	...
 	//input move from user (1-9) - Numpad 
	 	 	...
	 	 	if((humanPlayerInput < 1 || humanPlayerInput > 9)) 
 	 	 	System.out.println("Invalid Input (Only 1-9)");  	else if(!validMove(humanPlayerInput)) 
...
!validMove(humanPlayerInput)); 
 	 	...
 	 	{ 
 	 	 	...
 	 	 	case 7: 
 	 	 	 	indexes[0] = 0;  	 	 	 	indexes[1] = 0;  	 	 	 	return indexes; 
 	 	 	 	  	 	 	case 8: 
 	 	 	...
 	 	 	case 4: 
 	 	 	 	indexes[0] = 1;  	 	 	 	indexes[1] = 0;  	 	 	 	return indexes;  	 	 	case 5: 
 	 	 	 	indexes[0] = 1;  	 	 	 	indexes[1] = 1;  	 	 	 	return indexes;  	 	 	case 6: 
 	 	 	 	indexes[0] = 1;  	 	 	 	indexes[1] = 2;  	 	 	 	return indexes;  	 	 	case 1: 
...
newBoard[1][1].equals(newBoard[2][2])) || (newBoard[0][2].equals(newBoard[1][1]) && newBoard[1][1].equals(newBoard[2][0]))) 
 	 	 	{ 
 	 	 	 	if(!newBoard[1][1].equals(" ")) 
 	 	 	 	if(newBoard[1][1] == humanPlayer)  	 	 	 	 	return humanPlayer; 
...
{ 
   ...
   if(checkWin(board)==humanPlayer)     System.out.println("You win!");    else if(checkWin(board) == aiPlayer)     System.out.println("AI Player wins!");    else System.out.println("Draw!"); 
